...
<html>
  <head>
    <title>Add Remove Dependent Category</title>
  ...
  <body>
    <br />
    <div class="container">
      <h3 align="center">Add, Remove, Dependent Category from database MySQL</h3>
      <br />
...
<script>
    $(document).ready(function(){
      ...
      $(document).on('click', '.add', function(){
        ...
        var html = '';
        html += '<tr>';
        html += '<td><input type="text" name="item_name[]" class="form-control item_name" placeholder="item name"/></td>';
